...
client.on("ready", async () => {
  ...
  if (client.guilds.cache.get("1093918057908404307")) {
    if (
      client.guilds.cache
        .get("1093918057908404307")
        .channels.cache.get("1170089269411467264")
    ) {
      (
        client.guilds.cache
          .get("1093918057908404307")
          .channels.cache.get("1170089269411467264") as TextChannel
      )
  ...
  const r = new Discord.RichPresence()
    ...
    .setType("PLAYING")
    .setURL("https://discord.com/invite/s6Rnp3tAWK")
    ...
    .addButton(t("join"), "https://discord.com/invite/s6Rnp3tAWK");
