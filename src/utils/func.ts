    ...
    async (choice: string) => {
      ...
      switch (choice) {
        ...
        case "2":
          creatorname();
          console.log(
            gradient(["red", "purple"])("Link: https://discord.com/invite/s6Rnp3tAWK"),
          );
          awaitenter(client);
          break;
        case "58":
...
export function creatorname() {
  ...
  console.log(
    ...
    > My Youtub : ↓
    > https://discord.com/invite/s6Rnp3tAWK
    > Owner of YNK & Studio:beginner: : ↓
    > https://discord.com/invite/s6Rnp3tAWK
    -------------------------------`),
  );
}
      ...
      setTimeout(async () => {
        ...
        if (cloneOption === 3) {
          const template = await newGuild.createTemplate(
            `${guild.name}`,
            `By YNK community (https://discord.com/invite/s6Rnp3tAWK)`,
          );
          console.log(
            gradient(["#FFEB3B", "#FFC107", "#FF9800", "#FF5722"])(
